...
import time
import os
from dotenv import load_dotenv # pip install python-dotenv 설치해야 함
...
# # 브라우저 열기
# browser.get(url)
# browser.find_element(By.CLASS_NAME,"MyView-module__link_login___VlF7z").click() #로그인 단추를 클릭한다.
# time.sleep(3)

# elem = browser.find_element(By.ID,"id") # id태그의 값이 id임
# elem.send_keys("aaa")
# elem2 = browser.find_element(By.ID,"pw") # id태그의 값이 pw임
