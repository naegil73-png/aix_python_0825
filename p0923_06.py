...
# # 파일 BeautifulSoup변환
# # for i in range(2022,2027):
# #     print(f'movie_{i}.html')
# #     with open(f'movie_{i}.html','r',encoding='utf-8') as f:
...
# # 2.영화제목
# m_title = lis[0].find('strong',{'class':'tit-g clamp-g'}).get_text(strip=True)
# print(m_title)
# # 3.누적관객수
# m_des = lis[0].find('p',{'class':'conts-desc clamp-g'}).get_text(strip=True)
# print(int(m_des[3:-2].replace(",","")))
# # 4.개봉일자
...
for idx in range(2022,2027):
    print(f'p0923/file/movie_{idx}.html')
